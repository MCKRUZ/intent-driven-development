...
| **What is recorded** | A decision-log row with owner, reason and clock. The revised artifact. The list of what the change put at risk. The re-run gate report. |
